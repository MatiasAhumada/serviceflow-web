        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              La plataforma completa para gestionar tu negocio de forma profesional y eficiente.
            </p>
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 rounded-full bg-[#10B981]/10 hover:bg-[#10B981]/20 flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <button onClick={() => scrollToSection("features")} className="text-muted-foreground hover:text-[#10B981] transition-colors text-sm">
                  Características
                </button>
              </li>
              <li>
                <button onClick={() => scrollToSection("pricing")} className="text-muted-foreground hover:text-[#10B981] transition-colors text-sm">
                  Precios
                </button>
              </li>
              <li>
                <Link href="/app" className="text-muted-foreground hover:text-[#10B981] transition-colors text-sm">
                  Ingresar al Sistema
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-muted-foreground hover:text-[#10B981] transition-colors text-sm">
                  Sobre nosotros
                </a>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <a href="#" className="text-sm text-muted-foreground hover:text-[#10B981] transition-colors">
