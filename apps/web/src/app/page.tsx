...
export default function Home() {
  ...
  const { features, hasFeature, planType } = usePlanFeatures();
  ...
  const sidebarItems: SidebarItem[] = [
    ...
    // Productos (solo vendedor y comercio)
    ...(hasFeature("products") ? [{
      id: "products",
      label: "Productos",
      icon: (
    ...
    // Ventas (solo vendedor y comercio)
    ...(hasFeature("sales") ? [{
      id: "sales",
      label: "Ventas",
      icon: (
    ...
    // Órdenes de trabajo (solo taller y comercio)
    ...
    // Reparaciones (solo taller y comercio)
    ...(hasFeature("repairs") ? [{
      id: "repairs",
      label: "Reparaciones",
      icon: (
