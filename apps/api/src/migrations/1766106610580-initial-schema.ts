...
export class InitialSchema1766106610580 implements MigrationInterface {
  name = 'InitialSchema1766106610580';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "roles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "company_id" uuid NOT NULL, "name" character varying NOT NULL, "description" character varying, CONSTRAINT "PK_c1433d71a4838793a49dcad46ab" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."subscriptions_subscriber_type_enum" AS ENUM('user', 'company')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."subscriptions_status_enum" AS ENUM('active', 'inactive', 'cancelled', 'expired')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "companies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "cuit" character varying, "address_id" uuid, "email" character varying, "phone" character varying, "owner_user_id" uuid, "subscription_id" uuid, "created_by" uuid, CONSTRAINT "REL_ad150e1e829fc0c9013267f3e4" UNIQUE ("address_id"), CONSTRAINT "REL_f7a5bc09269d58369cf5f5b0c8" UNIQUE ("subscription_id"), CONSTRAINT "PK_d4bc3e82a314fa9e29f652c2c22" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "system_admin" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "email" character varying NOT NULL, CONSTRAINT "UQ_4b121b52b4a7ee8f11c43eef94d" UNIQUE ("email"), CONSTRAINT "PK_86d5c1f223e071b828153cc369b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."cash_movements_type_enum" AS ENUM('income', 'expense', 'adjustment')`,
    );
    await queryRunner.query(
      `CREATE TABLE "cash_movements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "cash_register_id" uuid NOT NULL, "user_id" uuid NOT NULL, "company_id" uuid, "type" "public"."cash_movements_type_enum" NOT NULL, "amount" numeric(10,2) NOT NULL, "concept" character varying NOT NULL, "notes" character varying, "date" TIMESTAMP NOT NULL, CONSTRAINT "PK_25faead19e1ff74153a01604d37" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."cash_registers_status_enum" AS ENUM('open', 'closed')`,
    );
    await queryRunner.query(
      `CREATE TABLE "cash_registers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "company_id" uuid, "user_id" uuid, "name" character varying NOT NULL, "current_balance" numeric(10,2) NOT NULL DEFAULT '0', "status" "public"."cash_registers_status_enum" NOT NULL DEFAULT 'closed', "opened_by" uuid, "closed_by" uuid, "open_time" TIMESTAMP, "close_time" TIMESTAMP, CONSTRAINT "PK_c1cc711056395d079d8f041ce34" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."sales_payment_method_enum" AS ENUM('credit_card', 'debit_card', 'bank_transfer', 'cash')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."sales_status_enum" AS ENUM('pending', 'completed', 'cancelled')`,
    );
    await queryRunner.query(
      `CREATE TABLE "sales" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "company_id" uuid, "user_id" uuid, "customer_id" uuid NOT NULL, "seller_id" uuid NOT NULL, "cashier_id" uuid, "cash_register_id" uuid, "sale_number" character varying NOT NULL, "date" TIMESTAMP NOT NULL, "total" numeric(10,2) NOT NULL, "payment_method" "public"."sales_payment_method_enum" NOT NULL, "status" "public"."sales_status_enum" NOT NULL DEFAULT 'pending', CONSTRAINT "PK_4f0bc990ae81dba46da680895ea" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_995aedbc7aebf5a2caa8311b63" ON "sales" ("company_id", "sale_number") `,
    );
    await queryRunner.query(
      `CREATE TABLE "service_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "service_order_id" uuid NOT NULL, "description" character varying NOT NULL, "labor_cost" numeric(10,2), "part_cost" numeric(10,2), "total" numeric(10,2) NOT NULL, CONSTRAINT "PK_7383c18e3c8e4956860b117728a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "warranties" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "service_order_id" uuid NOT NULL, "warranty_period_days" integer NOT NULL, "start_date" TIMESTAMP NOT NULL, "end_date" TIMESTAMP NOT NULL, "notes" character varying, CONSTRAINT "REL_659d4e293360caab63e2580b22" UNIQUE ("service_order_id"), CONSTRAINT "PK_62c441630f8a6ddcc4bc1ab1bc5" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."service_orders_status_enum" AS ENUM('received', 'in_progress', 'completed', 'delivered', 'cancelled')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."service_orders_payment_status_enum" AS ENUM('pending', 'completed', 'failed', 'refunded')`,
    );
    await queryRunner.query(
      `CREATE TABLE "service_orders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "company_id" uuid, "user_id" uuid, "customer_id" uuid NOT NULL, "technician_id" uuid NOT NULL, "received_by" uuid, "service_number" character varying NOT NULL, "status" "public"."service_orders_status_enum" NOT NULL DEFAULT 'received', "entry_date" TIMESTAMP NOT NULL, "expected_delivery" TIMESTAMP, "delivery_date" TIMESTAMP, "total_cost" numeric(10,2), "payment_status" "public"."service_orders_payment_status_enum", "notes" character varying, CONSTRAINT "PK_914aa74962ee83b10614ea2095d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_db7e6817578fb0901e5bfa9018" ON "service_orders" ("company_id", "service_number") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "supplier_products" ("supplier_id" uuid NOT NULL, "product_id" uuid NOT NULL, CONSTRAINT "PK_bb18600cc0829bc122f097b4f09" PRIMARY KEY ("supplier_id", "product_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "subscription_seats" ADD CONSTRAINT "FK_9a4455eab9dc94040aa62b60530" FOREIGN KEY ("subscription_id") REFERENCES "subscriptions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "payments" ADD CONSTRAINT "FK_75848dfef07fd19027e08ca81d2" FOREIGN KEY ("subscription_id") REFERENCES "subscriptions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD CONSTRAINT "FK_7e3cc01c420db5151aa21360358" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD CONSTRAINT "FK_9a92203195f8367519fd64dbe09" FOREIGN KEY ("created_by") REFERENCES "system_admin"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_a8f61a419ce5313def9b0f4c21e" FOREIGN KEY ("userTypeId") REFERENCES "user_types"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_368e146b785b574f42ae9e53d5e" FOREIGN KEY ("roleId") REFERENCES "roles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "companies" ADD CONSTRAINT "FK_ad150e1e829fc0c9013267f3e4c" FOREIGN KEY ("address_id") REFERENCES "addresses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "companies" ADD CONSTRAINT "FK_a2e26270eefa893caca40d8de4e" FOREIGN KEY ("owner_user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "companies" ADD CONSTRAINT "FK_f7a5bc09269d58369cf5f5b0c8a" FOREIGN KEY ("subscription_id") REFERENCES "subscriptions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "companies" ADD CONSTRAINT "FK_ca4df9b8772f1c1a02f3a560555" FOREIGN KEY ("created_by") REFERENCES "system_admin"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "cash_movements" ADD CONSTRAINT "FK_4a8c24eb16a7adad2154aeb1c55" FOREIGN KEY ("cash_register_id") REFERENCES "cash_registers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "cash_movements" ADD CONSTRAINT "FK_798030be2b2ae79a0b538e98f73" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "cash_movements" ADD CONSTRAINT "FK_8c43dbe2ad45aaaddd51615d8d9" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "cash_registers" ADD CONSTRAINT "FK_8ada87aa14dbc361cec58a11fe6" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "cash_registers" ADD CONSTRAINT "FK_f860498b8094442a69ca06f6ee2" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "cash_registers" ADD CONSTRAINT "FK_d08f513314ad93f22aa720e18ca" FOREIGN KEY ("opened_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "cash_registers" ADD CONSTRAINT "FK_b433fa68b7d170e913c5bbeb8a6" FOREIGN KEY ("closed_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "suppliers" ADD CONSTRAINT "FK_b3aba33228acd59f2d734c31b82" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "products" ADD CONSTRAINT "FK_b417f1726f6ccafb18730adffb0" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "sales" ADD CONSTRAINT "FK_6126ce1093dd7ed2d023c47633c" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "sales" ADD CONSTRAINT "FK_fbcb737b3ecc7c968b0dc167122" FOREIGN KEY ("seller_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "sales" ADD CONSTRAINT "FK_52ad26d289eda84215d133ff0f8" FOREIGN KEY ("cashier_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "service_items" ADD CONSTRAINT "FK_cd80f5e8a7935a4fbd75e278333" FOREIGN KEY ("service_order_id") REFERENCES "service_orders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "warranties" ADD CONSTRAINT "FK_659d4e293360caab63e2580b221" FOREIGN KEY ("service_order_id") REFERENCES "service_orders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_orders" ADD CONSTRAINT "FK_6f5204f6031a96cb5a2ea9c9295" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_orders" ADD CONSTRAINT "FK_f7680498e0f1a03041ef58ac9d8" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_orders" ADD CONSTRAINT "FK_2560471c48d4fcafc50ad885af7" FOREIGN KEY ("customer_id") REFERENCES "customers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_orders" ADD CONSTRAINT "FK_4c155a9cf2854e28444929e13aa" FOREIGN KEY ("technician_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_orders" ADD CONSTRAINT "FK_da79ccc984f603e5eab2380ff30" FOREIGN KEY ("received_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "devices" ADD CONSTRAINT "FK_abf5045e1ff3c852a53611c726a" FOREIGN KEY ("customer_id") REFERENCES "customers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "supplier_products" ADD CONSTRAINT "FK_4286173e1486a5c528f89dc798c" FOREIGN KEY ("supplier_id") REFERENCES "suppliers"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "devices" DROP CONSTRAINT "FK_abf5045e1ff3c852a53611c726a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_orders" DROP CONSTRAINT "FK_da79ccc984f603e5eab2380ff30"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_orders" DROP CONSTRAINT "FK_4c155a9cf2854e28444929e13aa"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_orders" DROP CONSTRAINT "FK_2560471c48d4fcafc50ad885af7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_orders" DROP CONSTRAINT "FK_f7680498e0f1a03041ef58ac9d8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_orders" DROP CONSTRAINT "FK_6f5204f6031a96cb5a2ea9c9295"`,
    );
    await queryRunner.query(
      `ALTER TABLE "warranties" DROP CONSTRAINT "FK_659d4e293360caab63e2580b221"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_items" DROP CONSTRAINT "FK_cd80f5e8a7935a4fbd75e278333"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sales" DROP CONSTRAINT "FK_5cfc9e8b83f5a30a6b9a89597f6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sales" DROP CONSTRAINT "FK_52ad26d289eda84215d133ff0f8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sales" DROP CONSTRAINT "FK_fbcb737b3ecc7c968b0dc167122"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "sales" DROP CONSTRAINT "FK_6126ce1093dd7ed2d023c47633c"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "products" DROP CONSTRAINT "FK_b417f1726f6ccafb18730adffb0"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "cash_registers" DROP CONSTRAINT "FK_b433fa68b7d170e913c5bbeb8a6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cash_registers" DROP CONSTRAINT "FK_d08f513314ad93f22aa720e18ca"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cash_registers" DROP CONSTRAINT "FK_f860498b8094442a69ca06f6ee2"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cash_registers" DROP CONSTRAINT "FK_8ada87aa14dbc361cec58a11fe6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cash_movements" DROP CONSTRAINT "FK_8c43dbe2ad45aaaddd51615d8d9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cash_movements" DROP CONSTRAINT "FK_798030be2b2ae79a0b538e98f73"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cash_movements" DROP CONSTRAINT "FK_4a8c24eb16a7adad2154aeb1c55"`,
    );
    await queryRunner.query(
      `ALTER TABLE "companies" DROP CONSTRAINT "FK_ca4df9b8772f1c1a02f3a560555"`,
    );
    await queryRunner.query(
      `ALTER TABLE "companies" DROP CONSTRAINT "FK_f7a5bc09269d58369cf5f5b0c8a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "companies" DROP CONSTRAINT "FK_a2e26270eefa893caca40d8de4e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "companies" DROP CONSTRAINT "FK_ad150e1e829fc0c9013267f3e4c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "FK_368e146b785b574f42ae9e53d5e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "FK_a8f61a419ce5313def9b0f4c21e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "FK_6f9395c9037632a31107c8a9e58"`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" DROP CONSTRAINT "FK_9a92203195f8367519fd64dbe09"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "subscription_seats" DROP CONSTRAINT "FK_9a4455eab9dc94040aa62b60530"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_db7e6817578fb0901e5bfa9018"`,
    );
    await queryRunner.query(`DROP TABLE "service_orders"`);
    await queryRunner.query(
      `DROP TYPE "public"."service_orders_payment_status_enum"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_995aedbc7aebf5a2caa8311b63"`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."subscriptions_subscriber_type_enum"`,
    );
