...
export class InitialSchema1766106610580 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."payments_method_enum" AS ENUM('credit_card', 'debit_card', 'bank_transfer', 'cash')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."subscriptions_subscriber_type_enum" AS ENUM('user', 'company')`);
        await queryRunner.query(`CREATE TYPE "public"."subscriptions_status_enum" AS ENUM('active', 'inactive', 'cancelled', 'expired')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."cash_movements_type_enum" AS ENUM('income', 'expense', 'adjustment')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."sales_payment_method_enum" AS ENUM('credit_card', 'debit_card', 'bank_transfer', 'cash')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."service_orders_status_enum" AS ENUM('received', 'in_progress', 'completed', 'delivered', 'cancelled')`);
        await queryRunner.query(`CREATE TYPE "public"."service_orders_payment_status_enum" AS ENUM('pending', 'completed', 'failed', 'refunded')`);
        ...
        await queryRunner.query(`ALTER TABLE "cash_movements" ADD CONSTRAINT "FK_4a8c24eb16a7adad2154aeb1c55" FOREIGN KEY ("cash_register_id") REFERENCES "cash_registers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "cash_movements" ADD CONSTRAINT "FK_8c43dbe2ad45aaaddd51615d8d9" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "sales" ADD CONSTRAINT "FK_52ad26d289eda84215d133ff0f8" FOREIGN KEY ("cashier_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "service_orders" ADD CONSTRAINT "FK_da79ccc984f603e5eab2380ff30" FOREIGN KEY ("received_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "service_orders" DROP CONSTRAINT "FK_da79ccc984f603e5eab2380ff30"`);
        ...
        await queryRunner.query(`ALTER TABLE "cash_movements" DROP CONSTRAINT "FK_8c43dbe2ad45aaaddd51615d8d9"`);
        await queryRunner.query(`ALTER TABLE "cash_movements" DROP CONSTRAINT "FK_798030be2b2ae79a0b538e98f73"`);
        await queryRunner.query(`ALTER TABLE "cash_movements" DROP CONSTRAINT "FK_4a8c24eb16a7adad2154aeb1c55"`);
